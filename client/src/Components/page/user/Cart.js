        ...
        <>
            ...
            <div className='all-grid'>
                ...
                <div className='result-grid'  >
                    <Grid container spacing={2} sx={{ marginTop:"10%",  border: '1px solid #ccc', borderRadius: '5px', backgroundColor: '#f0f0f0', width: '75%' }}>
                        <Grid item>
                        ...
                        <Grid item xs={6} sm container>
                            ...
                            <Grid item textAlign={'left'} style={{marginLeft:"-25%"}}>
                                <Typography variant="subtitle1" component="div">
                                    ฿ {cost}
                                </Typography>
                                <Typography variant="subtitle1" component="div">
