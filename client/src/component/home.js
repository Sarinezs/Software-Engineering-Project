            ...
            <body>
                ...
                <header>
                    <div class="container_ad">
                        <div class="banner_ad">
                            <div class="banner_ad-text">
                                {/* <img src="https://brand.assets.adidas.com/image/upload/ss24_bad_bunny_response_cl_white_logo_1_X_975a973aaa.png" alt="" width="149" height="71" loading="eager" fetchpriority="high"> */}
                                <h2>Bad Bunny Response CL Wonder White</h2>
                                <button id="btn_ad">SHOP NOW</button>
                            </div>
                        </div>
                    </div>
                </header>
